...
public class PatternObservateur extends junit.framework.TestCase {
    ...
    public void test1() {
        ...
        //on le fait 2 fois pour chaque Observer car il y a eu 2 insertions
        assertEquals(l1, o1.senders().pop());
        assertEquals(l1, o1.senders().pop()); 
        assertEquals(l1, o2.senders().pop());  
        assertEquals(l1, o2.senders().pop());  
        //le dernier element inseré dans la liste est retourné en premier
