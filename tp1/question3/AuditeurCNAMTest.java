...
public class AuditeurCNAMTest extends junit.framework.TestCase {
    ...
    private AuditeurCNAM auditeurCNAM;
    /**
    ...
    {
        auditeurCNAM = new AuditeurCNAM("nom1","prenom1","matricule1");
    }
    ...
    public void test_prenom_avec_accent(){
        ...
        assertEquals ("Mme Dupont Élodie", "Dupont", auditeur1.nom());
        assertEquals ("Mme Dupont Élodie", "Élodie", auditeur1.prenom());
        assertEquals ("prénom avec accent sur la première lettre ? ", "dupont_e", auditeur1.login());      
    }
   ...
   public void test_nom_prenom_avec_chiffres () {
       ...
       assertEquals ("login avec des chiffres dans le nom/prénom ? ", "dupont_s", auditeur1.login()); 
    }
}
